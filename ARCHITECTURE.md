...
flowchart TB
    ...
    subgraph dispatch [Dispatch and Governance]
        ...
        HybridDispatch["Hybrid Dispatch — Context Server (63 tools)"]
    ...
    HybridDispatch -->|"registry (63 tools)"| ToolRegistry
...
| `server/dispatch/mod.rs` | Hybrid dispatch — `dispatch_inner` checks ToolRegistry first (63 tools), falls back to legacy match (6 tools) |
