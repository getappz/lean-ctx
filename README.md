...
<details>
<summary><strong>Full feature list (75 MCP tools)</strong></summary>
...
Every command and all 75 MCP tools, organized as user journeys, plus
...
| **MCP** | All 75 tools via MCP protocol, no shell hooks | Protocol-only agents (JetBrains, VS Code, Zed, ...) |
...
- **75 MCP tools** — from simple file reads to multi-agent orchestration
